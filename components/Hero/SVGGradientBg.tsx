...
export default function SVGGradientBg() {
  ...
  return (
    <div className="pointer-events-none absolute left-0 top-0 -z-10 h-[100vh] w-screen overflow-hidden lg:min-h-[1000px]">
      <div className="relative h-full w-full">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.449226" stopColor="#8D1EA2" />
              <stop stopColor="#090EDB" />
              {/* <stop offset="1" stopColor="#090EDB" /> */}
            </linearGradient>
          </defs>
        </svg>
      </div>
